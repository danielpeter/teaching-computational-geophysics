...
def define_bc(*args,**keys):
    ...
    # Defines a default material properties for block 1
    ...
    cubit.cmd('block 1 attribute index 2 7500 ')   # vp
    cubit.cmd('block 1 attribute index 3 4300 ')   # vs
    cubit.cmd('block 1 attribute index 4 3200 ')   # rho
